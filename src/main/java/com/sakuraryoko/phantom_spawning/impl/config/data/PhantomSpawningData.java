...
package com.sakuraryoko.phantom_spawning.impl.config.data;
...
public class PhantomSpawningData implements IConfigData
{
	@SerializedName("___comment")
	public String comment = PhantomSpawningInit.getInstance().getModVersionString() + " Config";
	...
	@SerializedName("bats")
	public BatOptions BATS = new BatOptions();
